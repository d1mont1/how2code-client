    ...
    const addNewSection = () => {
        if (
            ...
            const newContent = {
                ...
                description: '',
                videoLength: '',
                videoSection: `Пустой раздел ${activeSection}`,
                links: [{ title: '', url: '' }],
            };
            setCourseContentData([...courseContentData, newContent]);
        }
        ...
        <div className="w-[80%] m-auto mt-24 p-3">
            <form onSubmit={handleSubmit}>
                        ...
                        <>
                            <div
                                    ...
                                    <>
                                        <div className="flex w-full items-center">
                                            <input
                                                type="text"
                                                className={`text-[20px] ${
                                                    item.videoSection === 'Пустой раздел'
                                                        ? 'w-[170px]'
                                                        : 'w-min'
                                ...
                                {!isCollapsed[index] && (
                                    <>
                                        <div className="my-3">
                                            <label className={styles.label}>Название видео</label>
                                            <input
                                                type="text"
                                                placeholder="Основы алгоритмов..."
                                        ...
                                        <div className="mb-3">
                                            <label className={styles.label}>URL-адрес видео</label>
                                            <input
                                                type="text"
                                                placeholder="d8asfElf12"
                                                className={`${styles.input}`}
                                                value={item.videoUrl}
                                                onChange={(e) => {
                                                    const updatedData = [...courseContentData];
                                        ...
                                        <div className="mb-3">
                                            <label className={styles.label}>Описание видео</label>
                                            <textarea
                                                rows={8}
                                                cols={30}
                                        ...
                                        {item?.links.map((link: any, linkIndex: number) => (
                                            ...
                                            <div className="mb-3 block">
                                                ...
                                                <input
                                                    type="text"
                                                    placeholder="Исходный код... (название ссылки)"
                                                    className={`${styles.input}`}
                                                    value={link.title}
                                                    onChange={(e) => {
                                                        const updatedData = [...courseContentData];
                                                ...
                                                <input
                                                    type="url"
                                                    placeholder="URL-адрес исходного кода... (URL-адрес ссылки)"
                                ...
                                {index === courseContentData.length - 1 && (
                                    <div>
                                        <p
                                            ...
                                            <AiOutlinePlusCircle className="mr-2" /> Добавить новый
                                            контент
                                        </p>
                                    </div>
                                )}
                ...
                <div
                    ...
                    <AiOutlinePlusCircle className="mr-2" /> Добавить новый раздел
                </div>
            </form>
