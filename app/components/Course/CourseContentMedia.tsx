        ...
        if (answerSuccess) {
            ...
            if (user.role !== 'admin') {
                socketId.emit('notification', {
                    ...
                    message: `У вас есть новый ответ на ваш вопрос в ${data[activeVideo].title}`,
                    userId: user._id,
                });
            }
        }
    ...
    return (
        <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
            ...
            <div className="w-full p-4 flex items-center justify-between bg-slate-500 bg-opacity-20 backdrop-blur shadow-[bg-slate-700] rounded shadow-inner">
                {['Обзор', 'Ресурсы', 'Вопрос и Ответ', 'Отзывы'].map((text, index) => (
                    <h5
                        key={index}
                                ...
                                <div className="flex w-full">
                                    ...
                                    <div className="w-full">
                                        <h5 className="pl-3 text-[20px] font-[500] dark:text-white text-black ">
                                            Оцените курс <span className="text-red-500">*</span>
                                        </h5>
                ...
                <div className="flex mb-2">
                    ...
                    <div className="pl-3 dark:text-white text-black">
                        <div className="flex items-center">
                            ...
                            {(item.user.role === 'admin' || item.user.role === 'mentor') && (
                                <VscVerifiedFilled
                                    className={`ml-2 text-[20px] ${
                                        item.user.role === 'admin'
                                            ? 'text-[#0095F6]'
